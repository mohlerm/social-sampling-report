...
% -------------------------------------------------------------------------------------------------
\renewcommand{\thesistype}{Semester}
...
% Set names
% -------------------------------------------------------------------------------------------------
\renewcommand{\thesisauthor}{Peter Muster}
\renewcommand{\thesisadvisor}{Hugh Watts}
...
\thesistitlepage{Thesis Title}{August 2007}
...
\begin{figure}[ht]
\centering
\subfigure[ETH logo]{\includegraphics[height=12mm]{figures/ETHlogo}}\quad
\subfigure[LST logo]{\includegraphics[height=12mm]{figures/LSTlogo}}
